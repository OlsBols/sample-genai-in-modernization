...
st.markdown("""
    ...
    """)
st.image("sampledata/landing_page_image.jpeg", caption="Generative AI in AWS MAP Assessment Phase")
...
st.warning(
   """ 💡 Remember, while our GenAI is a whiz at insights, it might occasionally +
   daydream—so always double-check its predictions!"""
)
