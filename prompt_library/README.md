...
|----------|-------------|----------|----------|-------------|----------------|
| **Modernization Opportunity** | Inventory Analysis | `get_invventory_analysis_prompt()` | `modernization_opportunity/invventory_analysis_prompt.py` | CSV inventory data | Asset categorization, performance analysis, DR assessment, risk evaluation |
